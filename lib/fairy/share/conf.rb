...
#  DEFAULT_CONF.PROCESSOR_BIN = DEFAULT_CONF.BIN+"/processor"
  ...
  DEFAULT_CONF.CONTROLLER_MAX_ACTIVE_NTASKS_IN_PROCESSOR = 10

  DEFAULT_CONF.CONTROLLER_ASSIGN_NEW_PROCESSOR_N_FACTOR = 1

  DEFAULT_CONF.POSTMAPPING_POLICY = nil

  DEFAULT_CONF.PREQUEUING_POLICY = {:queuing_class => :OnMemoryQueue}
  DEFAULT_CONF.POSTQUEUING_POLICY = {:queuing_class => :OnMemoryQueue}

  DEFAULT_CONF.POSTQUEUE_MAX_TRANSFER_SIZE = 10000
  DEFAULT_CONF.POOLQUEUE_POOL_THRESHOLD = 1000
  ...
  DEFAULT_CONF.MOD_GROUP_BY_BUFFERING_POLICY = {:buffering_class => :OnMemoryBuffer}
  DEFAULT_CONF.MOD_GROUP_BY_CMSB_THRESHOLD = 10000

  DEFAULT_CONF.BARRIER_MEMORY_BUFFERING_POLICY = {:queuing_class => :OnMemoryQueue}
...
## DEFAULT_CONF.VF_PREFIX is client setting.
  ...
  DEFAULT_CONF.LOG_IMPORT_NTIMES_POP = 10000

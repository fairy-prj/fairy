...
#  DEFAULT_CONF.PROCESSOR_BIN = DEFAULT_CONF.BIN+"/processor"
  ...
  DEFAULT_CONF.N_MOD_GROUP_BY = 4
  DEFAULT_CONF.HASH_MODULE = "fairy/share/hash-md5"
  DEFAULT_CONF.HASH_OPTIMIZE = false

  DEFAULT_CONF.MOD_GROUP_BY_BUFFERING_POLICY = {:buffering_class => :DirectMergeSortBuffer}
  DEFAULT_CONF.MOD_GROUP_BY_CMSB_THRESHOLD = 400_000
